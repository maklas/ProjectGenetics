...
public class FunctionGraphState extends AbstractEngineState {
    ...
    protected void addSystems(Engine engine) {
        ...
        engine.add(new FunctionRenderSystem().setDrawFunctions(true).setDrawAxis(true).setDrawAxisPortions(false).setDrawNet(false).setAxisColor(Color.BLACK).setNumberColor(Color.BLACK).setAxisNames("X", "Y"));
